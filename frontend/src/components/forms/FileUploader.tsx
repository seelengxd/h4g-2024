...
const FileUploader: React.FC<FileUploaderProps> = ({ fileConstraintLabel, icon, hx="h-64", ...props }: FileUploaderProps) => {
  return (
    <div className="flex items-center justify-center w-full">
      <div className={`flex flex-col items-center justify-center w-full ${hx} border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 overflow-hidden p-4`}>
