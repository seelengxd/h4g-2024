    ...
    <div className="absolute top-0 left-0 z-20">
      <div className="relative w-24 h-screen group bg-primary-600 hover:w-96">
        <div className="flex flex-col justify-center h-screen">
          <div className="flex flex-col items-center space-y-24 group-hover:hidden ">
          ...
          <div className="flex-col hidden px-8 space-y-24 text-white transition group-hover:flex">
            <Link
              to={profile.linkTo}
              className={
                "flex items-center w-full gap-8 p-4 text-white rounded-3xl" +
