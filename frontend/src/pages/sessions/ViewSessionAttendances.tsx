...
import { ListBulletIcon, ArrowDownOnSquareIcon } from "@heroicons/react/24/outline";
  ...
  return (
    <div className="items-center justify-between p-6 mx-auto mt-8 max-w-7xl lg:px-8">
      ...
      <div className="flex flex-col bg-white p-8 rounded-md shadow gap-4 h-full col-span-1">
        <Tabs tabs={[allRegistrationsTab, pendingRegistrationsTab, attendedRegistrationsTab, absentRegistrationsTab]} defaultTabId="all" />
      </div>
    </div>
  );
}
